...
echo_and_run cd "/home/vietanh/catkin_ws/src/onrobot/onrobot_rg_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/vietanh/catkin_ws/src/onrobot/onrobot_rg_modbus_tcp/setup.py" \
    egg_info --egg-base /home/vietanh/catkin_ws/build/onrobot/onrobot_rg_modbus_tcp \
    build --build-base "/home/vietanh/catkin_ws/build/onrobot/onrobot_rg_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
