...
(cl:in-package onrobot_vg_control-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name onrobot_vg_control-srv:<SetCommand-request> is deprecated: use onrobot_vg_control-srv:SetCommand-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <SetCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader onrobot_vg_control-srv:command-val is deprecated.  Use onrobot_vg_control-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCommand-request>)))
  ...
  "onrobot_vg_control/SetCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCommand-request)))
  "Returns string type for a service object of type 'SetCommand-request"
  "onrobot_vg_control/SetCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name onrobot_vg_control-srv:<SetCommand-response> is deprecated: use onrobot_vg_control-srv:SetCommand-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader onrobot_vg_control-srv:success-val is deprecated.  Use onrobot_vg_control-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader onrobot_vg_control-srv:message-val is deprecated.  Use onrobot_vg_control-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCommand-response>)))
  ...
  "onrobot_vg_control/SetCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCommand-response)))
  "Returns string type for a service object of type 'SetCommand-response"
  "onrobot_vg_control/SetCommandResponse")
